...
This project has two goals. Firstly, I aimed to segment a data set into various categories to investigate how compensation differs based on factors like an employee's role, department, experience level, and demographics. Secondly, I wanted to craft a customized dashboard using R and its packages, enabling personalized visualizations tailored to specific needs.
