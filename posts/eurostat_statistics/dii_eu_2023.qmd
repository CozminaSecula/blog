...
[Digital Intensity Index (DII)](https://circabc.europa.eu/ui/group/89577311-0f9b-4fc0-b8c2-2aaa7d3ccb91/library/84b390d2-6a83-4dae-8aba-37c18557eb5b/details) is a composite indicator, derived from the survey on ICT usage and e-commerce in enterprises.
...
# Filter for only four indicators
...
The biggest proportion of enterprises (that participated in the survey) reaching a very high level of the DII in 2023 was in Finland (13.01%), followed by Malta (11.43%) and the Netherlands (10.97%). On the other hand, enterprises in Romania (72.07%), Bulgaria (70.64%) and Greece (56.17%) have very low digital intensity.
