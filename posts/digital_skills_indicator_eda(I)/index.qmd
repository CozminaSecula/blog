...
The data analyzed in this post is sourced from Eurostat’s database on individuals’ digital skills.

The analysis uses several packages, including `eurostat`[^3] for data retrieval, `tidyverse`[^4] for data manipulation and visualization, `janitor`[^5] for data cleaning, `reactable`[^6] for interactive tables and `patchwork`[^7] for plot composition.
...
[^9]: [Histogram](https://flowingdata.com/wp-content/themes/fd-modern-6-0/images/chart-types/histogram.png) ![](images/clipboard-249601241.png)

[^10]: [Boxplot](https://i0.wp.com/flowingdata.com/wp-content/uploads/2008/02/box-plot-explained.gif?w=1090) ![](images/clipboard-3227116470.png)

[^11]: [Boxplot](https://i0.wp.com/flowingdata.com/wp-content/uploads/2008/02/box-plot-explained.gif?w=1090) ![](images/clipboard-3227116470.png)
