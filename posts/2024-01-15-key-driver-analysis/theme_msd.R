...
theme_msd <- function() {
  theme_minimal(base_size = 8) +
    theme(
      ...
      axis.line = element_line(linewidth = .1, color = GRAY9),
      axis.text = element_text(color = GRAY7),
      axis.ticks.x = element_line(linewidth = 0.5, color = GRAY9),
      axis.ticks.y = element_line(linewidth = 0.5, color = GRAY9),
      ...
      plot.subtitle = element_text(color = GRAY4, size= 10),
