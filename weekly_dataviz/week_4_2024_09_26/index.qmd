...
Some time ago, I looked at the components of the [**EU Digital Intensity Index (DII)**](https://cozminasecula.github.io/blog/posts/digital_intensity_index_components_eu/). One of these components is the **Data Analytics Indicator**. This week’s data visualization shows the adoption of data analytics by EU enterprises in 2023.\
...
The visualization is a slope chart (also known as a slope graph), illustrating the changes in the percentage of EU enterprises that adopted **Big Data** in 2020 and **Data Analytics** in 2023. It’s important to note that this is not a direct comparison of identical indicators. In 2023, the **Data Analytics** indicator replaced the **Big Data** indicator in the **(DII)**. Since **Data Analytics** covers a broader range of technologies, the chart reflects how adoption rates shifted when the indicator was changed, rather than comparing the same technologies across both years.
...
callout <- paste0("EU countries improved their <br>performance when Big Data <br>was replaced with Data Analytics <br>indicator. However, increased EU and <br>national efforts may be needed <br>to reach 75% adoption by 2030.")
...
-   Hungary and Croatia show the highest adoption rates in 2023, with Hungary leading at 53% and Croatia close behind at 52%. These high rates reflect how quickly these countries have adapted to the broader **Data Analytics** technologies, moving toward the EU's goal for business adoption of data analytics.

-   The transition from **Big Data** to **Data Analytics** has resulted in some progress for Romania. However, Romania remains significantly behind, with only 22% adoption in 2023, indicating that it may require additional support or strategic initiatives to meet the EU's digital transformation objectives for this indicator.

-   **Malta** shows moderate growth, from 30% to 36% .

-   Although adoption rates shifted for all countries when the indicator was changed, resulting in some progress, both EU and national efforts may need increased investment and focus to achieve 75% data analytics adoption by 2030.
